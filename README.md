...
## Usage
  1. Copy your configs like `.config/nvim` and rename it as lazynvim_cpp or lazynvim_py and so on.
  2. In your .zshrc add lines like this:
    alias nvim-cpp='NVIM_APPNAME=lazynvim_cpp nvim'
    alias nvim-py='NVIM_APPNAME=lazynvim_py nvim'
